...
def main():
    ...
    option_arr = [
        "--set-cookie-file=file.txt",
        "--use-cookie-file=file.txt",
        ...
        "--js-file=file.js",
        "--wait-for-cookie",
        "--print-request (print requested urls)",
...
"""
    ...
    web = BrowseUrlT(
        ...
        print_pdf=print_pdf,
        set_html=set_html,
        set_html_path=set_html_path,
        get_link=get_link,
        js_raw=js_raw,
        js_progress=js_progress,
