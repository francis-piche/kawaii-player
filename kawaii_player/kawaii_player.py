...
if not BROWSER_BACKEND or (
    BROWSER_BACKEND != "QTWEBKIT" and BROWSER_BACKEND != "QTWEBENGINE"
):
    if os.path.exists(HOME_OPT_FILE) and not BROWSER_BACKEND:
        ...
        change_opt_file(
            HOME_OPT_FILE, "BROWSER_BACKEND=", "BROWSER_BACKEND=QTWEBENGINE"
        )
...
if BROWSER_BACKEND == "QTWEBENGINE":
    try:
        ...
        try:
            ...
            change_opt_file(
                HOME_OPT_FILE, "BROWSER_BACKEND=", "BROWSER_BACKEND=QTWEBKIT"
            )
            BROWSER_BACKEND = "QTWEBKIT"
        except Exception as err_msg:
            print(err_msg)
            msg_txt = (
                "Browser Backend Not Available. Install either QtWebKit or QtWebEngine"
            )
...
class Ui_MainWindow(object):
    def setupUi(
        ...
        self.label.setup_globals(
            MainWindow, self, home, TMPDIR, logger, screen_width, screen_height, "label"
        )

        self.label_new = ThumbnailWidget(MainWindow)
        self.label_new.setup_globals(
            MainWindow,
            self,
            home,
            TMPDIR,
        ...
        for i in self.hide_btn_menu_option:
            self.action_player_menu2.append(
                self.hide_btn_list1_menu.addAction(
                    i, lambda x=i: self.playerPlaylist1(x)
                )
            )
        ...
        self.horizontalLayout_goto_epn.setObjectName(
            _fromUtf8("horizontalLayout_goto_epn")
        )
        ...
        self.horizontalLayout_torrent_frame.setObjectName(
            _fromUtf8("horizontalLayout_torrent_frame")
        )
        ...
        self.horizontalLayout_torrent_frame.addWidget(
            self.label_torrent_stop, 0, 0, 1, 1
        )
        ...
        self.label_down_speed.setToolTip(
            "Set Download Speed Limit For Current Session in KB\nEnter Only Integer Values"
        )
        ...
        self.label_up_speed.setToolTip(
            "Set Upload Speed Limit in KB for Current Session\nEnter Only Integer Values"
        )
        ...
        self.horizontalLayout_torrent_frame.addWidget(
            self.label_torrent_status, 1, 0, 5, 3
        )
        ...
        self.horizontalLayout_player_opt.setObjectName(
            _fromUtf8("horizontalLayout_player_opt")
        )
        ...
        self.player_showhide_title_list.setObjectName(
            _fromUtf8("player_showhide_title_list")
        )
        self.horizontalLayout_player_opt.insertWidget(
            9, self.player_showhide_title_list, 0
        )
        self.player_showhide_title_list.setText("T")
        self.player_showhide_title_list.clicked_connect(
            lambda x=0: self.playerPlaylist("Show/Hide Title List")
        )
        ...
        self.player_showhide_playlist.setObjectName(
            _fromUtf8("player_showhide_playlist")
        )
        self.horizontalLayout_player_opt.insertWidget(
            10, self.player_showhide_playlist, 0
        )
        ...
        self.player_menu_option = [
            "Show/Hide Video",
            "Show/Hide Cover And Summary",
            "Lock Playlist",
            "Shuffle",
            "Stop After Current File (Ctrl+Q)",
            "Continue(default Mode)",
            "Set Media Server User/PassWord",
            "Start Media Server",
            "Broadcast Server",
            "Turn ON Remote Control",
            "Set Current Background As Default",
            "Preferences (Ctrl+P)",
        ]
        ...
        self.horizontalLayout_player_opt.insertWidget(
            27, self.player_play_pause_play, 0
        )
        ...
        self.horizontalLayout_player_opt.insertWidget(
            28, self.player_play_pause_pause, 0
        )
        ...
        self.horizontalLayout_player_opt.insertWidget(
            31, self.player_btn_update_list2, 0
        )
        ...
        self.horizontalLayout_player_opt.insertWidget(
            33, self.set_quality_server_btn, 0
        )
        ...
        self.VerticalLayoutLabel_Dock3 = QtWidgets.QVBoxLayout(
            self.dockWidgetContents_3
        )
        self.VerticalLayoutLabel_Dock3.setObjectName(
            _fromUtf8("VerticalLayoutLabel_Dock3")
        )
        ...
        self.btnGoWeb.clicked_connect(lambda x=0: self.reviewsWeb(action="btn_pushed"))
        ...
        self.libmpv_save_prop = namedtuple(
            "prop", "aid sid rem_quit seek_time cur_time asp vol"
        )
        ...
        self.list_poster = TitleListWidgetPoster(
            MainWindow, self, home, TMPDIR, logger, screen_width, screen_height
        )
        ...
        self.widget_dict = {
            ...
            "scrollArea1": self.scrollArea1,
            "frame": self.frame,
            "dock_3": self.dockWidget_3,
            "tab_2": self.tab_2,
            "tab_6": self.tab_6,
        }
        self.user_agent = (
        ...
        if OSNAME == "posix":
            ...
            verify = False
        self.vnt = Vinanti(
            block=False, hdrs={"User-Agent": self.user_agent}, verify=verify
        )
        ...
        self.frame_extra_toolbar.setMaximumSize(
            QtCore.QSize(self.width_allowed1, int(screen_height / 1.5))
        )
        ...
        self.list1.itemDoubleClicked["QListWidgetItem*"].connect(
            self.list1_double_clicked
        )
        ...
        self.goto_epn_filter_txt.textChanged["QString"].connect(
            self.filter_epn_list_txt
        )
    ...
    def decide_widgets_on_video(self, over_video=None, widgets="all"):
        if self.widgets_on_video:
            if self.player_val == "libmpv" and over_video is False:
                ...
                and self.tab_5.mpv.get_property("idle-active") is False
                and self.fullscreen_video
            ):
    ...
    def mpv_next(self, *args):
        if (
            self.player_val == "libmpv"
            and self.tab_5.mpv.get_property("playlist-count") > 0
        ):
            self.tab_5.get_next()
        else:
    ...
    def set_mainwindow_palette(
        self, fanart, first_time=None, theme=None, rgb_tuple=None
    ):
        if theme is None or theme == "default":
            ...
            if os.path.isfile(fanart):
                if not self.keep_background_constant or first_time:
                    ...
                    palette.setBrush(
                        QtGui.QPalette.Background, QtGui.QBrush(QtGui.QPixmap(fanart))
                    )
    ...
    def update_video_dict_criteria(self):
        ...
        if not os.path.isfile(video_category_path):
            ...
            logger.info(
                "{0}::{1}::--1808--".format(self.category_dict, self.category_array)
            )
    ...
    def legacy_ffmpegthumbnailer(
        self, picn, interval, path, width_allowed=None, from_client=None
    ):
        path = path.replace('"', "")
        inter = str(interval)
    ...
    def generate_thumbnail_method(
        ...
        if path.endswith(".mp3") or path.endswith(".flac"):
            ...
            if self.player_val in ["libmpv", "mpv"]:
                ...
                self.slider.mpv_preview(
                    TMPDIR, "{}%".format(inter), None, picn, path, timeout=5
                )
                if os.path.exists(picn) and os.stat(picn).st_size and not from_client:
                    self.create_new_image_pixel(picn, 128)
                    self.create_new_image_pixel(picn, 480)
                    ...
                    if self.player_val == "mpv":
                        ...
                        proc = subprocess.call(
                            [
                                ...
                                "-nosound",
                                "-vo",
                                "jpeg:quality=100:outdir=" + new_tmp,
                                "-ss",
                                str(inter),
                                "-endpos",
                                "1",
    ...
    def create_new_image_pixel(self, art_url, pixel):
        ...
        try:
            if not os.path.exists(abs_path_thumb) and os.path.exists(art_url):
                ...
                art_url_name = (
                    str(pixel) + "px." + os.path.basename(self.default_background)
                )
                path_thumb, new_title = os.path.split(self.default_background)
                abs_path_thumb = os.path.join(path_thumb, art_url_name)

                if not os.path.exists(abs_path_thumb) and os.path.exists(
            ...
            if stop_now:
                if self.video_local_stream or new_video_local_stream:
                    ...
                    if isinstance(queue_item, tuple):
                        ...
                        logger.debug(
                            "queue:{0}::list6:{1}".format(
                                len(self.queue_url_list, self.list6.count())
                            )
                        )
        except Exception as e:
            logger.error(e)
    ...
    def queueList_return_pressed(self, r):
        ...
        if isinstance(queue_item, tuple):
            ...
            self.getQueueInList()
        logger.debug(
            "queue:{0}::list6:{1}".format(len(self.queue_url_list), self.list6.count())
        )
    ...
    def subMplayer(self):
        ...
        if self.final_playing_url in self.history_dict_obj:
            (
                ...
                vol,
                asp,
            ) = self.history_dict_obj.get(self.final_playing_url)
            aid = audio_id
            sid = sub_id
        ...
        if site != "Music" or rem_quit:
            if vol != "auto" and self.restore_volume:
                QtCore.QTimer.singleShot(
                    100, partial(self.set_sub_audio_text, "vol", value=vol)
                )
            aspect = self.mpvplayer_aspect.get(str(self.mpvplayer_aspect_cycle))
            if self.restore_aspect:
                QtCore.QTimer.singleShot(
                    500, partial(self.set_sub_audio_text, "asp", value=asp)
                )
    ...
    def mark_epn_thumbnail_label_new(self, txt, index):
        ...
        label_number.setTextColor(
            self.thumbnail_text_color_dict[self.thumbnail_text_color_focus]
        )
        try:
    ...
    def thumbnail_window_present_mode(self, mode=None):
        ...
        if MainWindow.isFullScreen() and mode != 5:
            ...
            p6 = (
                "self.gridLayout2.addWidget(self.label_epn_"
                + str(thumbnail_index)
                + ", "
                + str(r)
                + ", "
    ...
    def playerStop(self, msg=None, restart=None, *args):
        ...
        if self.player_val == "libmpv":
            ...
            if self.tab_5.stop_msg and self.tab_5.stop_msg == "openglwidget":
                ...
                self.tab_5.rem_properties(
                    self.final_playing_url, 0, self.progress_counter
                )
        ...
        if self.mpvplayer_val.processId() > 0 or msg or self.player_val == "libmpv":
            ...
            if msg == "remember quit" or (
                self.stop_from_client and self.mplayerLength > 480
            ):
                rem_quit = 1
            else:
                rem_quit = 0
            if site != "Music" or rem_quit:
                ...
                if (
                    self.player_val == "libmpv"
                    and self.stop_from_client
                    and self.pc_to_pc_casting == "slave"
                ):
                ...
                if self.player_val == "libmpv":
                    logger.debug(
                        self.history_dict_obj_libmpv.get(self.final_playing_url)
                    )
                else:
            ...
            self.player_play_pause.setText(self.player_buttons["play"])
            if (
                self.tab_6.isHidden() and (str(self.idw) == self.get_winid())
            ) or msg == "darwin":
                change_spacing = True
                if not self.float_window.isHidden():
                    ...
                    if self.tab_2.isHidden():
                        if self.fullscreen_mode == 0:
                            if self.view_mode in ["thumbnail", "thumbnail_light"] and (
                                msg == "darwin" or self.player_val in ["mpv", "mplayer"]
                            ):
                                pass
                            else:
                            ...
                            and self.view_mode != "thumbnail_light"
                        ):
                            self.tab_6.show()
                            self.frame2.show()
                            self.frame1.show()
                            ...
                            if self.video_mode_index != 1:
                                ...
                                self.thumbnail_label_update_epn()
                            QtCore.QTimer.singleShot(
                                1000, partial(self.update_thumbnail_position)
                            )
                    else:
                        pass
                    self.gridLayout.setContentsMargins(5, 5, 5, 5)
                ...
                if not self.float_window.isHidden():
                    ...
                    if (
                    ...
                    elif str(self.idw) in [
                        str(int(self.label.winId())),
                        str(int(self.label_new.winId())),
                    ]:
                        if self.player_theme == "default":
                        ...
                        if self.video_mode_index == 7:
                            ...
                            fs = False
                            logger.debug(
                                "{0}, {1}::original {2}, {3}".format(
                                    wd, ht, screen_width, screen_height
                                )
                            )
            ...
            if (
                (
                    (MainWindow.isFullScreen() and self.tab_6.isHidden())
                    or self.fullscreen_mode == 1
                )
                and not self.force_fs
                and not self.stop_from_client
                and self.fullscreen_video
            ):
                MainWindow.showNormal()
                MainWindow.showMaximized()
    ...
    def playerPlayPause(self, *args):
        ...
        if txt == self.player_buttons["play"]:
            if self.mpvplayer_val.processId() > 0 or (
                self.player_val == "libmpv"
                and self.tab_5.mpv.get_property("idle-active") is False
            ):
                if self.player_val in ["mpv", "libmpv"]:
                    ...
                    counter = str(
                        datetime.timedelta(seconds=int(self.progress_counter))
                    )
                    cmd = (
                        'show-text "${osd-sym-cc}'
                        + counter
                        + " / "
                        + str(self.mpv_playback_duration)
                        + '" 2000'
                    )
                    logger.info(cmd)
                    self.mpv_execute_command(cmd, "", 100)
                ...
                if self.list2.currentItem():
                    ...
                    if not self.idw or self.idw == self.get_winid():
                        ...
                        p1 = "self.label_epn_{0}.winId()".format(
                            str(self.thumbnail_label_number[0])
                        )
                        id_w = eval(p1)
        ...
        if val == "Show/Hide Cover And Summary":
            ...
            if not self.list2.isHidden():
                ...
                if width != screen_width or height != screen_height:
                    self.text.setMaximumWidth(
                        self.text.maximumWidth() + self.width_allowed
                    )
                    self.label_new.setMaximumWidth(
                        self.text.maximumWidth() + self.width_allowed
                    )
            ...
            if v == "turn on remote control":
                ...
                change_opt_file(
                    HOME_OPT_FILE, "REMOTE_CONTROL=", "REMOTE_CONTROL=False"
                )
            ...
            if val == "Order by Name(Descending)":
                try:
                    self.epn_arr_list = sorted(
                        self.epn_arr_list,
                        key=lambda x: create_key(
                            str(x).split("	")[0].replace("#", "", 1)
                        ),
                        reverse=True,
                    )
                except Exception as err:
        ...
        if self.view_mode == "thumbnail_light":
            ...
            try:
                self.labelFrame2.setText(
                    "{0}. {1}".format(
                        self.list1.currentRow() + 1, self.list1.currentItem().text()
                    )
                )
            except Exception as err:
                logger.error(err)
    ...
    def display_image(
        ...
        if site == "Video":
            ...
            if os.path.exists(os.path.join(home, "Local", name_tmp, "summary.txt")):
                summary = open_files(
                    os.path.join(home, "Local", name_tmp, "summary.txt"), False
                )
                m.append(summary)
            else:
            ...
            if os.path.exists(
                ...
                summary = open_files(
                    os.path.join(home, "Music", "Artist", name_tmp, "bio.txt"), False
                )
                m.append(summary)
            else:
                m.append("Summary Not Available")
            ...
            if os.path.exists(dir_name):
                ...
                thumbnail = os.path.join(
                    home, "History", site, name_tmp, "thumbnail.jpg"
                )
                picn = thumbnail
        ...
        if br_cnt_opt == "image_list":
            if picn != "No.jpg" and os.path.exists(picn):
                if dimn:
                    picn = self.image_fit_option(
                        picn, "", fit_size=6, widget_size=(int(dimn[0]), int(dimn[1]))
                    )
    ...
    def next_page(self, value_str):
        ...
        if total_till == 0 or value_str == "not_deleted" or value_str == "zoom":
            ...
            while i < length:
                ...
                if value_str == "deleted":
                    p1 = "self.label_{0} = TitleThumbnailWidget(self.scrollAreaWidgetContents)".format(
                        i
                    )
                    exec(p1)
                ...
                self.gridLayout1.addWidget(
                    label_title, j, k, 1, 1, QtCore.Qt.AlignCenter
                )
                label_title.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignBottom)
                label_title.setMouseTracking(True)

                if value_str == "deleted":
                    p1 = "self.label_{0} = QtWidgets.QLabel(self.scrollAreaWidgetContents)".format(
                        length + i
                    )
                    exec(p1)
                ...
                self.gridLayout1.addWidget(
                    label_title_txt, j1, k, 1, 1, QtCore.Qt.AlignCenter
                )
                ...
                if value_str == "deleted" or value_str == "zoom":
                    self.display_image(
                        i, "image", iconv_r_poster, value_str, dimn=dim_tuple
                    )
                ...
                if k == iconv_r_poster:
                    ...
                    k = 0
                    self.labelFrame2.setText(
                        "Wait...{0}/{1}".format(int(i / 2), int(length / 2))
                    )
                    QtWidgets.QApplication.processEvents()
        ...
        if total_till_epn > 0:
            ...
            while i < length:
                ...
                if not label_hide:
                    ...
                    self.gridLayout2.addWidget(
                        label_epn, j, k, 1, 1, QtCore.Qt.AlignCenter
                    )
                    label_epn.show()
                i = i + 1
                k = k + 1
                ...
                if not label_hide:
                    ...
                    self.gridLayout2.addWidget(
                        label_epn_txt, jj, kk, 1, 1, QtCore.Qt.AlignCenter
                    )
                    label_epn_txt.show()
                else:
                    label_epn_txt.hide()
        ...
        if total_till_epn > 0:
            ...
            while i < length:
                ...
                if not label_hide:
                    if site in ["Video", "Music", "PlayLists", "MyServer", "None"]:
                        ...
                        if self.list1.currentItem():
                            ...
                            name_t = ""
                        picn = self.get_thumbnail_image_path(
                            counter, self.epn_arr_list[counter]
                        )
                    else:
                    ...
                    if site == "Video":
                        picn = self.image_fit_option(
                            picn_old, picn_old, fit_size=2, widget=label_epn
                        )
                    else:
                        picn = self.image_fit_option(
                            picn_old,
                            "",
                            fit_size=6,
                            widget_size=(int(width), int(height)),
                        )
                    img = QtGui.QPixmap(picn, "1")
                ...
                if kk == iconv_r:
                    ...
                    kk = 0
                    self.labelFrame2.setText(
                        "Wait...{0}/{1}".format(int(i), int(length))
                    )
                    # QtWidgets.QApplication.processEvents()
    ...
    def get_thumbnail_image_path(
        ...
        if fullsize and filename:
            picn = filename
        if (
            (picn and not os.path.exists(picn) and "http" not in path)
            or (
                picn
                and not os.path.exists(picn)
                and "http" in path
            ...
            or (
                picn
                and "http" in path
                and site.lower() == "myserver"
                and not os.path.exists(picn)
            )
            or start_async
            or ("master_abs_path=" in path and not os.path.exists(picn))
            or fullsize
        ):
            path = path.replace('"', "")
            if (
                ("http" in path and "youtube.com" in path and "/watch?" in path)
                or ("http" in path and site.lower() == "myserver")
                or "master_abs_path=" in path
            ):
            ...
            if fullsize:
                ...
                size = None
            self.threadPoolthumb.append(
                ThreadingThumbnail(self, logger, path, picn, inter, size)
            )
        ...
        if total_till_epn == 0:
            ...
            while i < length:
                if prev_count >= 0 and prev_count <= length and i < prev_count:
                    ...
                    create_widget = True
                p1 = "self.label_epn_{0} = ThumbnailWidget(self.scrollAreaWidgetContents1)".format(
                    i
                )
                exec(p1)
                ...
                label_epn.setup_globals(
                    MainWindow, ui, home, TMPDIR, logger, screen_width, screen_height
                )
                label_epn.setMaximumSize(QtCore.QSize(width, height))
                label_epn.setMinimumSize(QtCore.QSize(width, height))
                label_epn.setObjectName(_fromUtf8("label_epn_{0}".format(i)))
                ...
                if self.player_theme == "dark":
                    ...
                    """.format(
                            self.list_text_color, self.list_text_color_focus
                        )
                    )
                counter = i
                start_already = False
                if site in ["None", "Music", "Video", "MyServer", "PlayLists"]:
                    ...
                    if not os.path.exists(picn):
                        picn = self.get_thumbnail_image_path(
                            counter, self.epn_arr_list[counter], start_async=True
                        )
                        new_obj = SetThumbnailGrid(
                            self,
                            logger,
                            counter,
                            picn,
                ...
                p1 = "self.label_epn_{} = QtWidgets.QLabel(self.scrollAreaWidgetContents1)".format(
                    ii
                )
                exec(p1)
    ...
    def epnClicked(self, dock_check=None):
        ...
        if self.float_window.isHidden():
            if (
                ...
                and self.idw != self.get_winid()
                and thumbnail_indicator
            ):
                num = self.list2.currentRow()
                if self.mpvplayer_val.processId() > 0:
                    self.mpvNextEpnList(play_row=num, mode="play_now")
                else:
                    exec_str = "self.label_epn_{0}.change_video_mode({1}, {2})".format(
                        num, self.video_mode_index, num
                    )
                    exec(exec_str)
                thumb_mode = True
            else:
            ...
            if not self.idw or self.idw == self.get_winid():
                self.epnfound()
            elif self.idw == str(int(self.label.winId())) or self.idw == str(
                int(self.label_new.winId())
            ):
                self.epnfound()
            else:
        ...
        if (
            ...
            if thumb_mode:
                exec_str = 'self.label_epn_{0}.player_thumbnail_fs(mode="{1}")'.format(
                    num, "fs"
                )
                exec(exec_str)
            else:
        ...
        if self.mpvplayer_val.processId() > 0:
            if play_row != None and mode == "play_now":
                ...
                if self.cur_row == self.list2.count() - 1:
                    self.cur_row = 0
                    if (site == "Music" and not self.playerPlaylist_setLoop_var) or (
                        self.list2.count() == 1
                    ):
            ...
            if site in ["Music", "Video", "None", "PlayLists", "MyServer"]:
                ...
                if self.external_url:
                    ...
                    if lnk_epn.startswith("abs_path=") or lnk_epn.startswith(
                        "relative_path="
                    ):
                ...
                if self.gapless_network_stream:
                    if (
                        self.tmp_pls_file_dict.get(self.cur_row)
                        and self.playback_mode == "playlist"
                    ):
                        if self.tmp_pls_file_lines[self.cur_row].startswith("http"):
                            ...
                            self.mpv_execute_command(
                                "set playlist-pos {}".format(self.cur_row), self.cur_row
                            )
    ...
    def HideEveryThing(self, widget_except=None, mode=None):
        if not self.search_on_type_btn.isHidden():
            ...
            if not self.status_dict_widget:
                self.status_dict_widget = {
                    "list1": ui.list1.isHidden(),
                    "list2": ui.list2.isHidden(),
                    "frame1": ui.frame1.isHidden(),
                    "label": ui.label.isHidden(),
                    "label_new": ui.label_new.isHidden(),
                    "text": ui.text.isHidden(),
                    "player": ui.tab_5.isHidden(),
                    "scrollArea": ui.scrollArea.isHidden(),
                    "scrollArea1": ui.scrollArea1.isHidden(),
                    "frame": ui.frame.isHidden(),
                    "dock_3": ui.dockWidget_3.isHidden(),
                    "tab_2": ui.tab_2.isHidden(),
    ...
    def IconViewEpn(self, start=None, mode=None):
        ...
        if (
            self.tab_6.isHidden()
            or self.view_mode in ["thumbnail", "thumbnail_light"]
            or start
        ):
            self.list1.hide()
            self.list2.hide()
    ...
    def shuffleList(self):
        ...
        if site in ["Music", "Video"] and self.original_path_name:
            ...
            if "/" in tmp:
                self.original_path_name = random.sample(
                    self.original_path_name, len(self.original_path_name)
                )
            ...
            if "/" in tmp:
                if site == "Video":
                    self.original_path_name = sorted(
                        self.original_path_name, key=lambda x: x.split("	")[0].lower()
                    )
                else:
                    self.original_path_name = sorted(
                        self.original_path_name,
    ...
    def metadata_copy(
        self, dir_path, picn, thumbnail=None, mode=None, img_opt=None, site=None
    ):
        ...
        if mode == "img" and os.path.isfile(picn) and thumbnail:
            ...
            self.videoImage(
                picn,
                os.path.join(dir_path, "thumbnail.jpg"),
    ...
    def get_metadata_location(
        self, site, opt, siteName, new_name, mode=None, copy_sum=None, find_name=None
    ):
        picn = ""
        img_opt = ""
        thumbnail = ""
        ...
        if new_name and mode == "img":
            ...
            if not os.path.exists(picn) or (
                (os.path.exists(picn) and not os.stat(picn).st_size)
            ):
                picn = os.path.join(TMPDIR, new_name + ".jpg")
        ...
        if (
            os.path.isfile(picn)
            and opt == "History"
            and site.lower() not in ["video", "music"]
            and new_name
        ):
    ...
    def metadata_fetched(self, *args):
        ...
        if val == "info":
            ...
            txt = "{} ({}) \n\nGenres: {} \n\n{}".format(
                obj.title, aired, genres, obj.summary
            )
            logger.debug(txt)
            ...
            if arr and fan:
                logger.debug(arr[0])
                self.vnt.get(
                    arr[0], out=fanart, onfinished=partial(self.copyFanart, nm)
                )
        elif val == "episode-info" and eps and vd and epr:
            self.metaengine.map_episodes(
                tvdb_dict=obj.episode_summary.copy(),
                epn_arr=epr.copy(),
                name=nm,
                site=st,
                video_dir=vd,
        ...
        if backend == "alter":
            ...
            if get_all:
                self.posterfound_arr[len(self.posterfound_arr) - 1].finished.connect(
                    lambda x=0: self.posterfound_thread_all_finished(
                        name,
                        url,
                        direct_url,
                        copy_fanart,
                ...
                self.posterfound_arr[len(self.posterfound_arr) - 1].finished.connect(
                    lambda x=0: self.posterfound_thread_finished(
                        name, copy_fanart, copy_poster, copy_summary
                    )
                )
            ...
            for i in range(0, total):
                ...
                if direct_url and copy_poster and not copy_fanart:
                    thumb = os.path.join(TMPDIR, name + ".jpg")
                    self.vnt.get(
                        srch_term, out=thumb, onfinished=partial(self.copyImg, name)
                    )
                elif direct_url and copy_fanart and not copy_poster:
                    fanart = os.path.join(TMPDIR, name + "-fanart.jpg")
                    self.vnt.get(
                        srch_term, out=fanart, onfinished=partial(self.copyFanart, name)
                    )
                else:
                    if not get_all:
    ...
    def name_adjust(self, name):
        ...
        nam = re.sub(
            '\+season[^"]*|\+special[^"]*|xvid|bdrip|brrip|ac3|hdtv|dvdrip', "", nam
        )
        nam = nam.strip()
        if nam.endswith("+"):
            nam = nam[:-1]
    ...
    def posterfound_thread_finished(self, name, copy_fan, copy_poster, copy_summary):
        logger.info(
            "{0}-{1}-{2}--{3}--posterfound_thread_finished--".format(
                name, copy_fan, copy_poster, copy_summary
            )
        )
        copy_sum = "Not Available"
        if copy_summary:
            copy_sum = self.text.toPlainText().replace(
                "Wait..Downloading Poster and Fanart..\n\n", ""
            )
        if copy_poster:
    ...
    def posterfound_thread_all_finished(
        self, name, url, direct_url, copy_fanart, copy_poster, copy_summary, use_search
    ):
        ...
        if copy_summary:
            self.text.setText(copy_sum)
        range_val = 3
        if (self.posterfind_batch == self.poster_count_start) or (
            self.posterfind_batch % range_val == 0
        ):
    ...
    def get_final_link(self, url, quality, ytdl_path, loger, nm, hdr):
        logger.info(
            "{0}-{1}-{2}--{3}--get-final--link--".format(url, quality, ytdl_path, nm)
        )
        self.ytdl_arr.append(
            YTdlThread(self, logger, url, quality, ytdl_path, loger, nm, hdr)
        )
        length = len(self.ytdl_arr) - 1
        self.ytdl_arr[len(self.ytdl_arr) - 1].finished.connect(
            lambda x=0: self.got_final_link(length)
        )
        ...
        if site.lower() == "local":
            ...
            if self.list1.currentItem():
                file_path = os.path.join(
                    home, "Playlists", self.list1.currentItem().text()
                )
            ...
            if item:
                if "	" in self.epn_arr_list[row]:
                    if self.epn_arr_list[row].startswith("#") and mark_val == "unmark":
                        ...
                        not self.epn_arr_list[row].startswith("#")
                        and mark_val == "mark"
                    ):
    ...
    def update_list2(self, epn_arr=None, show_thumb=None):
        ...
        if not self.epn_arr_list and epn_arr is None:
            ...
            if self.list1.currentItem():
                ...
                title_list = "NONE"
            new_thread = SetThumbnail(
                self, logger, new_epn_arr, update_pl_thumb, title_list
            )
            self.set_thumbnail_thread_list.append(new_thread)
            self.set_thumbnail_thread_list[
                len(self.set_thumbnail_thread_list) - 1
            ].finished.connect(
                partial(
    ...
    def mark_History(self):
        ...
        if opt == "History" and site != "PlayLists":
            if siteName:
                if os.path.exists(
                    os.path.join(home, "History", site, siteName, name, "Ep.txt")
                ):
                    file_path = os.path.join(
                        home, "History", site, siteName, name, "Ep.txt"
                    )
            else:
    ...
    def deleteHistory(self):
        ...
        if bookmark and os.path.exists(os.path.join(home, "Bookmark", status + ".txt")):
            ...
            if siteName:
                if os.path.exists(
                    os.path.join(home, "History", site, siteName, "history.txt")
                ):
                    file_path = os.path.join(
                        home, "History", site, siteName, "history.txt"
                    )
            else:
            ...
            if item and nam:
                if self.epn_arr_list:
                    ...
                    thumbnail_server_path = os.path.join(
                        home, "thumbnails", "thumbnail_server"
                    )
                    logger.info("{0}--thumbnail--path--".format(icon_dir_path))
                    icon_dir_list = [thumb_path, thumbnail_server_path]
                    if (
                        icon_dir_path.startswith(thumb_path)
                        and icon_dir_path not in icon_dir_list
                    ):
                        if os.path.exists(icon_dir_path):
                            shutil.rmtree(icon_dir_path)
                            logger.info(
                                "{0}--thumbnail--directory--deleted--".format(
                                    icon_dir_path
                                )
                            )
    ...
    def epn_highlight(self):
        ...
        if self.list2.currentItem() and num < len(self.epn_arr_list) and num >= 0:
            ...
            if (
                os.path.exists(picn)
                and not picn.endswith("default.jpg")
                and self.list_poster.isHidden()
            ):
                if self.player_theme == "default":
                    widget = self.label
                    fit_size = 6
                    ...
                    try:
                        if row < self.list2.count():
                            ...
                            if (
                                ...
                                ui.list_poster.item(row).setIcon(
                                    QtGui.QIcon(icon_new_pixel)
                                )
                    except Exception as err:
                        logger.error(err)
        except Exception as err:
    ...
    def preview(self):
        ...
        self.player_val = txt
        if (
            self.mpvplayer_val.processId() > 0
            and self.tab_2.isHidden()
            and self.player_val in ["mpv", "mplayer"]
        ):
            self.mpvplayer_val.kill()
            self.mpvplayer_started = False
            self.epnfound()
    ...
    def nextp(self, val):
        ...
        self.list1.verticalScrollBar().setValue(
            self.list1.verticalScrollBar().minimum()
        )
    ...
    def gotopage(self):
        ...
        if (
            key
            and opt
            and site not in ["Video", "Music", "None", "MyServer", "PlayLists"]
        ):
            self.list1.verticalScrollBar().setValue(
                self.list1.verticalScrollBar().minimum()
            )
    ...
    def reviewsWeb(self, srch_txt=None, review_site=None, action=None):
        ...
        if not self.web and review_site:
            try:
                self.web = Browser(
                    self, home, screen_width, self.quality_val, site, self.epn_arr_list
                )
            except NameError:
                site = "None"
                self.epn_arr_list = []
            ...
            if (
                "youtube" in review_site.lower()
                and "youtube" not in cur_location
                and QT_WEB_ENGINE
            ):
                self.web.close()
    ...
    def search(self):
        ...
        if site and (site not in site_arr) and self.site_var:
            ...
            site == "None" and self.btn1.currentText().lower() == "youtube"
        ) or not self.tab_2.isHidden():
            self.video_local_stream = False
            self.mirror_change.hide()
            self.line.setPlaceholderText("Search Available")
            self.line.setReadOnly(False)
                ...
                if opt != "History" or site.lower() == "myserver":
                    try:
                        ...
                        (
                            ...
                            self.record_history,
                            self.depth_list,
                        ) = self.site_var.getEpnList(
                            name, opt, self.depth_list, extra_info, siteName, category
                        )
                    except Exception as e:
                        print(e)
                    if not m:
        ...
        if site not in ["PlayLists", "Music", "Video", "None"]:
            ...
            if row_select >= 0:
                ...
                if send_list is None:
                    ...
                    if not send_list:
                        ...
                        self.record_history, self.depth_list = (
                            send_list[3],
                            send_list[4],
                        )
                        ...
                        logger.info(picn)
                        logger.info(
                            "site={0};opt={1};name={2};extra_info={3}".format(
                ...
                if opt != "History" or site.lower() == "myserver":
                    ...
                    if os.path.isfile(hist_path) and self.record_history:
                        if OSNAME != "posix":
                            new_name_with_info = self.replace_special_characters(
                                new_name_with_info
                            )
                        if os.stat(hist_path).st_size == 0:
                            write_files(
                                hist_path, new_name_with_info, line_by_line=True
                            )
                        else:
                    ...
                    hist_site = os.path.join(hist_dir, name)
                    hist_epn = os.path.join(hist_site, "Ep.txt")
                    if (not os.path.exists(hist_site) and self.record_history) or (
                        os.path.exists(hist_epn)
                    ):
                        try:
                            first_try = False
                            if not os.path.exists(hist_site):
                                ...
                                if self.video_local_stream:
                                    ...
                                    title_torrent = os.path.join(
                                        hist_site, "title.torrent"
                                    )
                            ...
                            if first_try:
                                hist_sum = os.path.join(hist_site, "summary.txt")
                                hist_picn = os.path.join(hist_site, "poster.jpg")
                                self.summary_write_and_image_copy(
                                    hist_sum, summary, picn, hist_picn
                                )
                        except Exception as e:
                            print(e)
                            return 0
            ...
            if item:
                ...
                if not bookmark:
                    ...
                    if (
                        video_opt.lower() != "update"
                        and video_opt.lower() != "updateall"
                    ):
                        ...
                        if art_n in self.video_dict:
                            ...
                            m = self.media_data.get_video_db(
                                video_db, "Directory", art_n
                            )
                            mlist = [list(i) for i in m]
                    ...
                    if new_dir_path is not None:
                        if new_dir_path.lower() != "none":
                            ...
                            m = self.media_data.get_video_db(
                                video_db, "Directory", new_art_n
                            )
                        else:
                            m = self.media_data.get_video_db(
                                video_db, "Bookmark", new_art_n
                            )
                    else:
                        m = self.media_data.get_video_db(
                            video_db, "Bookmark", new_art_n
                ...
                if video_opt.lower() == "recent":
                    check_path = (
                        lambda x: os.path.getctime(x) if os.path.exists(x) else 0
                    )
                ...
                if os.path.exists(dir_path):
                    ...
                    if os.path.exists(summary1):
                        ...
                        summary = "Not Available"
                        titles = [
                            i.split("\t")[0].replace("#", "") for i in self.epn_arr_list
                        ]
                        summary = "\n".join(titles)
                        summary = art_n + "\n\n" + summary
                    ...
                    if not os.path.isfile(picn) and self.epn_arr_list:
                        picn = self.get_thumbnail_image_path(
                            0, self.epn_arr_list[0], fullsize=True, filename=picn
                        )
                    self.videoImage(picn, thumbnail, fanart, summary)
                    logger.info(picn)
                else:
    ...
    def use_playlist_method(self):
        ...
        if site in self.local_site_list:
            for j, i in enumerate(self.epn_arr_list):
                ...
                if item:
                    item = item.replace('"', "")
                    if item.startswith("abs_path=") or item.startswith(
                        "relative_path="
                    ):
        ...
        if artist_mode:
            ...
            if self.list1.currentItem():
                ...
                if not os.path.exists(music_dir_art_name):
                    ...
                    if (
                        not os.path.exists(poster)
                        and srch != "offline"
                        and self.get_artist_metadata
                    ):
                        self.threadPool.append(ThreadingExample(nm, logger, TMPDIR))
                        self.threadPool[len(self.threadPool) - 1].finished.connect(
                            lambda x=nm: self.finishedM(nm)
                        )
            ...
            if nm:
                ...
                thumb = os.path.join(music_dir_art_name, "thumbnail.jpg")
                logger.info(
                    "poster={0}--srch={1}--artist={2}".format(
                        poster, srch, artist_name_mplayer
                    )
                )
                if (
                    not os.path.exists(poster)
                    ...
                    os.path.exists(poster)
                    or os.path.exists(fan)
                    or os.path.exists(thumb)
                ):
                    self.videoImage(poster, thumb, fan, summary)
                else:
                    try:
                        r = self.list2.currentRow()
                        thumb_path = self.get_thumbnail_image_path(
                            r, self.epn_arr_list[r]
                        )
    ...
    def image_fit_option(
        self, picn, fanart, fit_size=None, widget=None, widget_size=None, color=None
    ):
        """
        ...
        try:
            if fit_size:
                if (fit_size == 1 or fit_size == 2) or fit_size > 100:
                    ...
                    if fit_size == 5:
                        offset = (
                            int((screen_width - wsize) / 2),
                            int((screen_height - baseheight) / 2),
                        )
                    else:
                    ...
                    baseheight = screen_height - (
                        self.frame1.height() + self.label.height() + 100
                    )
                    ...
                    try:
                        ...
                        logger.error(
                            "{0}::Error in opening image, videoImage ---13321".format(e)
                        )
                        picn = os.path.join(home, "default.jpg")
                        img = Image.open(str(picn))
                    wpercent = basewidth / float(img.size[0])
        ...
        try:
            ...
            if os.path.isfile(str(picn)):
                ...
                if os.path.isfile(thumbnail):
                    ...
                    get_thumbnail = True
                if get_thumbnail:
                    self.image_fit_option(
                        picn, thumbnail, fit_size=6, widget=self.label
                    )
                poster = picn
                picn = thumbnail
                ...
                try:
                    ...
                    if "poster.jpg" in poster:
                        if not os.path.exists(poster_picn):
                            self.image_fit_option(
                                poster, poster_picn, fit_size=6, widget=self.label
                            )
                        picn = poster_picn
                except Exception as e:
                    print(e, "--10147--")
                ...
                if self.player_theme != "default" and "thumbnail_server" in picn:
                    logger.debug(
                        "Escaping thumbnail label for theme = {}".format(
                            self.player_theme
                        )
                    )
                else:
            ...
            if os.path.exists(self.default_background):
                self.gui_signals.fanart_changed(
                    self.default_background, self.player_theme
                )
                dir_n, p = os.path.split(self.default_background)
                new_jpg = os.path.join(dir_n, "default_poster.jpg")
                if not os.path.exists(new_jpg):
    ...
    def get_file_name(self, row, list_widget):
        ...
        if row < len(self.epn_arr_list):
            ...
            if final_val.startswith("abs_path=") or final_val.startswith(
                "relative_path="
            ):
        ...
        try:
            ...
            logger.info(
                "--14986--function_get_file_name={0}-{1}".format(
                    file_name_mkv, file_name_mp4
                )
            )
        ...
        if (
            ...
            file_name_mkv = os.path.join(
                self.default_download_location, title, new_epn_mkv
            )
            file_name_mp4 = os.path.join(
                self.default_download_location, title, new_epn_mp4
            )
            ...
            if not self.queue_url_list:
                ...
                if isinstance(queue_item, tuple):
                    ...
                    if len(queue_split) > 1:
                        st = queue_split[1]
                        if st.startswith("abs_path=") or st.startswith(
                            "relative_path="
                        ):
                            st = self.if_path_is_rel(st)
    ...
    def gapless_play_now(self, win_id, eofcode, finalUrl):
        if (eofcode == "next" or eofcode is None) and self.playback_mode == "playlist":
            ...
            if self.gapless_playback and site in [
                "Video",
                "Music",
                "None",
                "MyServer",
                ...
                if self.music_playlist or site == "PlayLists":
                    if self.tmp_pls_file_lines[self.cur_row].startswith("http") and (
                        os.path.isfile(turl) or turl.startswith("http")
                    ):
                        from_function = "now_start"
            else:
                from_function = "now_start"
            command = self.mplayermpv_command(
                self.idw, finalUrl, self.player_val, from_function=from_function
            )
    ...
    def play_file_now(self, file_name, win_id=None, eofcode=None):
        ...
        if (
            self.mpvplayer_val.processId() > 0
            and self.mpvplayer_started
            and not finalUrl.startswith("http")
            ...
            if not self.gapless_playback and self.player_val != "libmpv":
                ...
                self.use_playlist_method()
                if isinstance(self.cur_row, int) and self.cur_row < len(
                    self.tmp_pls_file_lines
                ):
                    self.tmp_pls_file_lines[self.cur_row] = finalUrl.replace('"', "")
                if self.tmp_pls_file_lines:
                    write_files(
                        self.tmp_pls_file, self.tmp_pls_file_lines, line_by_line=True
                    )
                self.playback_mode = "playlist"
                if (
                    self.tab_5.mpv.get_property("idle-active") is True
                    or self.stale_playlist
                ):
        ...
        asp = self.mpvplayer_aspect.get(str(self.mpvplayer_aspect_cycle))
        if (
            self.final_playing_url in self.history_dict_obj
            and self.player_val != "libmpv"
        ):
            (
                seek_time,
                cur_time,
    ...
    def if_file_path_exists_then_play(
        self, row, list_widget, play_now=None, eofcode=None
    ):
        global site, artist_name_mplayer

        file_path_name_mp4, file_path_name_mkv = self.get_file_name(row, list_widget)
        if (
            (os.path.exists(file_path_name_mp4) or os.path.exists(file_path_name_mkv))
            and (
                site.lower() != "video"
                and site.lower() != "music"
                and site.lower() != "local"
            ...
            logger.info(
                "now--playing: {0}-{1}".format(file_path_name_mp4, file_path_name_mkv)
            )
            if play_now:
            ...
            if self.list3.currentItem().text().lower() == "playlist":
                logger.info(
                    "now--playing: {0}-{1}--8626".format(
                        file_path_name_mp4, file_path_name_mkv
                    )
                )
                if play_now:
                    self.epn_name_in_list = (
                        list_widget.item(row).text().replace("#", "", 1)
                    )
                    if self.epn_name_in_list.startswith(self.check_symbol):
                        self.epn_name_in_list = self.epn_name_in_list[1:]
                    if os.path.exists(file_path_name_mp4):
            ...
            if play_now:
                ...
                if site.lower() == "video":
                    try:
                        ...
                        logger.error(
                            "Error in getting Thumbnail - localvideogetinlist: {0}".format(
                                e
                            )
                        )
            ...
            (site.lower() in ["playlists", "myserver"] or self.music_playlist)
            and self.player_val == "libmpv"
            and play_now
        ):
            self.use_playlist_method()
        ...
        if path.startswith("abs_path="):
            ...
            if nm.startswith("http"):
                ...
                if nm.startswith(n_url):
                    ...
                    nm = self.yt.get_yt_url(
                        nm, ui.quality_val, ui.ytdl_path, logger, mode="offline"
                    )
                    if "::" in nm:
                        nm = nm.split("::")[0]
    ...
    def start_gapless_stream_process(self, row, link=None):
        if (
            self.tmp_pls_file_dict.get(row) is False
            ...
            print(row)
            if (
                self.tmp_pls_file_lines and row < len(self.tmp_pls_file_lines)
            ) or link is not None:
                if link is not None:
                    turl = link
                else:
                ...
                if (
                    ...
                    and "master_abs_path=" not in turl
                    and "master_relative_path=" not in turl
                    and site.lower() != "myserver"
                ):
                    if site == "Music":
    ...
    def epnfound_now_start_prefetch(self, url_lnk, row_val, mode):
        ...
        if (
            self.mpvplayer_val.processId() > 0 or self.player_val == "libmpv"
        ) and mode not in ["thumbnail", "thumbnail_gapless"]:
            if self.mpv_prefetch_url_started and self.player_val != "libmpv":
                ...
                if (
                    url_lnk.startswith("https://manifest.")
                    and self.cur_row
                    and self.cur_row + 1 < len(self.tmp_pls_file_lines)
                ):
    ...
    def mpv_execute_command(self, cmd, row, timer=None):
        if timer:
            QtCore.QTimer.singleShot(timer, partial(self.mpv_execute_command, cmd, row))
    ...
    def epnfound_now_start_player(self, url_link, row_val):
        ...
        if self.player_val == "mpv":
            if not referer:
                ...
                command = self.mplayermpv_command(
                    self.idw, finalUrl, self.player_val, rfr=referer
                )
            logger.info(command)
            self.infoPlay(command)
        elif self.player_val == "libmpv":
            ...
            if not referer:
                command = self.mplayermpv_command(
                    self.idw, finalUrl, self.player_val, a_url=aurl, s_url=surl
                )
            else:
                command = self.mplayermpv_command(
                    self.idw, finalUrl, self.player_val, rfr=referer
            ...
            if self.player_val.lower() in ["mpv", "mplayer"]:
                subprocess.Popen(
                    [self.player_val.lower(), finalUrl],
                    stdin=subprocess.PIPE,
                    stdout=subprocess.PIPE,
                )
            else:
                subprocess.Popen(
                    [self.player_val, finalUrl],
                    stdin=subprocess.PIPE,
                    stdout=subprocess.PIPE,
                )
    ...
    def epnfound(self):
        ...
        if self.mpvplayer_val.processId() > 0 and (
            self.final_playing_url.startswith("http")
        ...
        if site not in ["PlayLists", "None", "Music", "Video"]:
            ...
            if site != "Local":
                try:
                    ...
                    if self.video_local_stream:
                        self.quit_really = "yes"
                        if (
                            self.torrent_serve_thread.isRunning()
                            or self.torrent_status_thread.isRunning()
                        ):
                            finalUrl = self.start_torrent_stream(
                                name,
                                row,
                                self.local_ip + ":" + str(self.local_port),
                                "Next",
                                self.torrent_download_folder,
                                self.stream_session,
                            )
                        else:
                            (
                                finalUrl,
                                self.torrent_serve_thread,
                                self.torrent_status_thread,
                                self.stream_session,
                                self.torrent_handle,
                        ...
                        self.torrent_handle.set_upload_limit(self.torrent_upload_limit)
                        self.torrent_handle.set_download_limit(
                            self.torrent_download_limit
                        )
                    else:
                        if not self.epn_wait_thread.isRunning():
                            self.epn_wait_thread = PlayerGetEpn(
            ...
            if item:
                ...
                if len(arr) >= 2:
                    path_rel = arr[1]
                    if path_rel.startswith("abs_path=") or path_rel.startswith(
                        "relative_path="
                    ):
        ...
        if (
            site in self.local_site_list
            and (
                not type(finalUrl) is list
                ...
                if isinstance(finalUrl, list):
                    ...
                    if (
                        ...
                        if refererNeeded == True or rfr_needed:
                            ...
                            nepn = '"' + str(finalUrl[0]) + '"'
                            command = self.mplayermpv_command(
                                self.idw, nepn, self.player_val, rfr=rfr_url
                            )
                        else:
                            nepn = str(finalUrl[0])
                            command = self.mplayermpv_command(
                        ...
                        command = self.mplayermpv_command(
                            self.idw, epnShow, self.player_val
                        )
                    if self.player_val == "mpv":
                        self.infoPlay(command)
                    else:
                    ...
                    if finalUrlFound == True or site == "PlayLists" or rfr_needed:
                        if refererNeeded == True or rfr_needed:
                            ...
                            if self.player_val == "mplayer":
                                ...
                                command = self.mplayermpv_command(
                                    self.idw, final_url, self.player_val, rfr=rfr_url
                                )
                                logger.info(command)
                                self.infoPlay(command)
                            else:
                            ...
                            if self.player_val == "mplayer":
                                ...
                                final_url = str(finalUrl[0])
                                command = self.mplayermpv_command(
                                    self.idw, final_url, self.player_val
                                )
                                logger.info(command)
                                self.infoPlay(command)
                            else:
                                ...
                                if self.player_val.lower() in ["mpv", "mplayer"]:
                                    subprocess.Popen(
                                        [self.player_val.lower(), final_url]
                                    )
                                else:
        ...
        if not self.epn_wait_thread.isRunning():
            ...
            self.paste_background(row)
        if (
            self.pc_to_pc_casting == "slave"
            and "master_abs_path=" in self.final_playing_url
        ):
    ...
    def start_torrent_stream(
        ...
        logger.info(
            "torrent_dest={0} ; index={1}; path={2}".format(torrent_dest, index, path)
        )
        ...
        if status.lower() == "next":
            ...
            logger.info(
                "9637 thread-server running: {}".format(
                    self.torrent_serve_thread.isRunning()
                )
            )
            if (
                status.lower() == "first run"
                and not self.torrent_serve_thread.isRunning()
            ):
                ...
                for wait_count in range(0, 5):
                    ...
                    wait_count += 1
            logger.info(
                "9647 thread-server running: {}".format(
                    self.torrent_serve_thread.isRunning()
                )
            )
            torrent_handle = None
            ...
            if not self.torrent_status_thread.isRunning():
                torrent_status_thread = TorrentThread(
                    handle, cnt, cnt_limit, ses, row=index, from_client=from_client
                )
            ...
            if status.lower() == "first run":
                ...
                for i, f in enumerate(info.files()):
                    ...
                    if (
                        ...
                        and os.stat(new_path).st_size == new_size
                    ):
                        file_exists = True
                ...
                if file_queue:
                    convert_str = lambda txt: int(txt) if txt.isdigit() else txt.lower()
                    create_key = lambda txt: [
                        convert_str(i) for i in re.split("([0-9]+)", txt)
                    ]
            ...
            if item:
                ...
                if "youtube.com" in finalUrl or finalUrl.startswith("ytdl:"):
                    if self.gapless_network_stream and mode != "offline":
                        ...
                        yt_mode = "yt"
                    finalUrl = self.yt.get_yt_url(
                        finalUrl, self.quality_val, self.ytdl_path, logger, mode=yt_mode
                    )
        if site not in ["PlayLists", "None", "Music", "Video"]:
            if site != "Local":
                try:
                    if self.video_local_stream:
                        ...
                        finalUrl = self.site_var.getFinalUrl(
                            name, epn, mirrorNo, self.quality_val
                        )
                except:
                    return ""
        elif site in ["None", "Music", "Video"]:
            ...
            if site == "None" and self.btn1.currentText().lower() == "youtube":
                ...
                if mode == "offline":
                    ...
                    finalUrl = self.yt.get_yt_url(
                        finalUrl, self.quality_val, self.ytdl_path, logger
                    )
                finalUrl = '"' + finalUrl + '"'
    ...
    def infoWget(self, command, src, get_library=None):
        ...
        self.wget.readyReadStandardOutput.connect(
            partial(self.dataReadyW, self.wget, get_library)
        )
    ...
    def change_sid_aid_video(self, sid=None, aid=None, vol=None, asp=None):
        ...
        logger.debug(
            "sid={}::aid={}::vol={}::aspect={}::updating file info".format(
                sid, aid, vol, aasp
            )
        )
        ...
        try:
            ...
            if self.custom_mpv_input_conf and self.player_val.lower() == "mpv":
                if "set property: fullscreen" in a.lower():
                    ...
                    for asp_ratio in self.mpvplayer_aspect:
                        if aspect_val == self.mpvplayer_aspect[asp_ratio]:
                            ...
                            logger.info(
                                "SET ASPECT = {0}::{1}".format(
                                    self.mpvplayer_aspect_cycle, aspect_val
                                )
                            )
                            a = "ASPECT CHANGED"
                            if aspect_val == "-1":
                ...
                if a and "AV:" not in a and "A:" not in a:
                    ...
                    pass
            if (
                self.player_val.lower() == "mpv"
                and self.mplayerLength
                and (
                    "EOF code: 1" in a
                ...
                logger.debug(a)
                logger.debug(
                    "{0}::{1}".format(self.mplayerLength, self.progress_counter)
                )
                logger.debug("-- end --")
            if "icy info:" in a.lower() or "icy-title:" in a.lower():
                ...
                server._emitMeta(
                    "internet-radio#" + self.epn_name_in_list, site, self.epn_arr_list
                )
        except Exception as err:
            logger.error(err)
            a = ""
        try:
            if self.player_val.lower() == "mpv":
                if "AUDIO_ID" in a or "AUDIO_KEY_ID" in a:
                    ...
                    if mpl:
                        ...
                        if ":" in mpl:
                            ...
                            o = n.split(":")
                            self.mplayerLength = (
                                int(o[0]) * 3600 + int(o[1]) * 60 + int(o[2])
                            )
                    ...
                    if not self.mpv_start:
                        self.mpv_start = True
                        try:
                            msg = "Playing: {0}".format(
                                self.epn_name_in_list.replace("#", "", 1)
                            )
                    ...
                    if timearr:
                        ...
                        if percomp:
                            ...
                            if percomp:
                                ...
                                per_comp = (
                                    "("
                                    + str(int(100 * val / self.mplayerLength))
                                    + "%)"
                                )
                        ...
                        if self.progress_counter == self.mplayerLength:
                            ...
                            if (
                                self.gapless_network_stream
                                and not self.queue_url_list
                                ...
                                if self.progress_counter > int(self.mplayerLength / 2):
                                    if (self.cur_row + 1) < self.list2.count():
                                        ...
                                        item_index = 0
                                    if (
                                        self.tmp_pls_file_dict.get(item_index) is False
                                        and self.list2.count() > 1
                                    ):
                        ...
                        if cache_empty == "yes":
                            try:
                                if new_cache_val > self.cache_pause_seconds:
                                    cache_empty = "no"
                                    self.mpvplayer_val.write(b"\n set pause no \n")
                                    self.player_play_pause.setText(
                                        self.player_buttons["pause"]
                                    )
                                    if mpv_indicator:
                                        mpv_indicator.pop()
                                    if pause_indicator:
                    ...
                    "VO:" in a or "AO:" in a or "Stream opened successfully" in a
                ) and not self.mplayerLength:
                    self.cache_mpv_indicator = False
                    self.cache_mpv_counter = "00"
                    self.mpv_playback_duration = 0
                    ...
                    self.eof_lock = False
                    QtCore.QTimer.singleShot(
                        1000, partial(self.set_sub_audio_text, "aid")
                    )
                    QtCore.QTimer.singleShot(
                        1500, partial(self.set_sub_audio_text, "sid")
                    )
                    if OSNAME == "nt":
                        ...
                        if sub_spacing:
                            ...
                            QtCore.QTimer.singleShot(
                                2000,
                                partial(self.mpv_execute_command, cmd, self.cur_row),
                            )
                    if self.gapless_network_stream:
                        if self.append_audio_start:
                            if self.append_audio_gapless:
                                if self.append_counter > 0:
                                    self.append_counter = 0
                                    self.mpv_execute_command(
                                        "set aid 2", self.cur_row, timer=1000
                                    )
                elif (
                    self.eof_reached
                    and self.eof_lock
                    ...
                    if self.gapless_network_stream:
                        if self.append_audio_start:
                            if self.append_audio_gapless:
                                if self.append_counter > 0:
                                    self.mpv_execute_command(
                                        "set aid 2", self.cur_row, timer=2000
                                    )
                                else:
                    ...
                    if self.final_playing_url in self.history_dict_obj:
                        ...
                        if self.video_parameters:
                            if self.final_playing_url == self.video_parameters[0]:
                                ...
                                param_avail = True
                        if not param_avail:
                            asp = self.mpvplayer_aspect.get(
                                str(self.mpvplayer_aspect_cycle)
                            )
                            vol = self.player_volume
                        self.history_dict_obj.update(
                            {
                    ...
                    if self.queue_url_list:
                        ...
                        if OSNAME == "nt":
                            pls_file = "file:///{}".format(
                                self.tmp_pls_file.replace("\\", "/")
                            )
                    ...
                    if "HTTP error 403 Forbidden" in a:
                        ...
                        self.quit_really = "yes"
                    if (
                        self.playlist_continue
                        and self.quit_really == "no"
                        and not self.epn_wait_thread.isRunning()
                    ):
                        if self.tab_5.isHidden() and thumbnail_indicator:
                            ...
                            q3 = (
                                "self.label_epn_"
                                + str(length_1 + self.thumbnail_label_number[0])
                                + ".setText(self.epn_name_in_list)"
                            )
                            exec(q3)
                            q3 = (
                                "self.label_epn_"
                                ...
                                if self.gapless_network_stream:
                                    if self.tmp_pls_file_dict.get(self.cur_row):
                                        if self.tmp_pls_file_lines[
                                            ...
                                            move_ahead = False
                                            self.final_playing_url = self.tmp_pls_file_lines[
                                                self.cur_row
                                            ]
                                            tname = self.epn_arr_list[self.cur_row]
                                            if tname.startswith("#"):
                                                tname = tname.replace("#", "", 1)
                                            if "\t" in tname:
                                                self.epn_name_in_list = tname.split(
                                                    "\t"
                                                )[0]
                                            else:
                                                self.epn_name_in_list = tname
                                            ...
                                            self.float_window.setWindowTitle(
                                                self.epn_name_in_list
                                            )
                                            server._emitMeta(
                                                "Next", site, self.epn_arr_list
                                            )
                                            if (
                                                self.cur_row == 0
                                                and "master_abs_path="
                                                in self.final_playing_url
                                            ):
                                                move_ahead = True
                                            if (
                                                self.pc_to_pc_casting == "slave"
                ...
                if "ID_LENGTH" in a and not self.mplayerLength:
                    ...
                    self.slider.setRange(0, int(self.mplayerLength))
                    self.total_file_size = int(
                        (
                            (self.id_audio_bitrate + self.id_video_bitrate)
                            * self.mplayerLength
                        )
                        / (8 * 1024 * 1024 * 1000)
                    )
                ...
                if ("A:" in a) or ("PAUSE" in a):
                    if not self.mpv_start:
                        ...
                        try:
                            if self.tab_5.mplayer_aspect_msg:
                                aspect_val = self.mpvplayer_aspect.get(
                                    str(self.mpvplayer_aspect_cycle)
                                )
                                if aspect_val == "-1":
                                    show_text_val = "Original Aspect"
                    ...
                    if "PAUSE" in a:
                        ...
                        if buffering_mplayer == "yes" or self.mplayer_pause_buffer:
                            ...
                            if (
                                (not self.mplayer_timer.isActive())
                                and (not self.video_local_stream)
                                and c_int > 0
                            ):
                        ...
                        if site == "Music":
                            out_time = (
                                str(datetime.timedelta(milliseconds=int(l)))
                                + " / "
                                + str(
                                    datetime.timedelta(
                                        milliseconds=int(self.mplayerLength)
                                    )
                                )
                            )
                        ...
                        if self.video_local_stream:
                            if (
                                c == "0%"
                                and not self.mplayer_pause_buffer
                                and not self.mplayer_nop_error_pause
                            ):
                                self.mpvplayer_val.write(b"\n pause \n")
                                self.mplayer_pause_buffer = True
                    if (cache_empty == "yes") and (
                        site != "Local" or site != "Music" or site != "Video"
                    ):
                    ...
                    elif ("nop_streaming_read_error" in a) and (
                        site != "Local" or site != "Music" or site != "Video"
                    ):
                        print("---nop--error--pausing---")
                        if not self.mplayer_pause_buffer:
                    ...
                    if self.player_setLoop_var:
                        ...
                        if not self.queue_url_list:
                            ...
                            if self.cur_row == self.list2.count() - 1:
                                ...
                                if (
                                    site == "Music"
                                    and not self.playerPlaylist_setLoop_var
                                ):
                                    r1 = self.list1.currentRow()
                                    it1 = self.list1.item(r1)
                                    if it1:
    ...
    def started(self):
        ...
        if (
            self.tab_5.isHidden()
            and thumbnail_indicator
            and self.video_mode_index not in [6, 7]
        ):
            length_1 = self.list2.count()
            q3 = (
                "self.label_epn_"
    ...
    def finished(self):
        ...
        if (
            self.quit_really == "no"
            and self.mpvplayer_val.processId() == 0
            and platform.system().lower() == "linux"
            and OSNAME == "posix"
            and self.mpvplayer_started
            and self.mplayer_finished_counter == 1
        ):
            self.player_restart()
        if platform.system().lower() == "darwin":
        ...
        if item:
            if (
                ...
                if finalUrl.startswith('"'):
                    ...
                    finalUrl = finalUrl.replace("'", "")
                if finalUrl.startswith("abs_path=") or finalUrl.startswith(
                    "relative_path="
                ):
        ...
        if not command:
            ...
            if self.mpvplayer_val.processId() > 0:
                ...
                if self.mpvplayer_command:
                    ...
                    self.mpvplayer_command[:] = []
                self.tab_5.set_mpvplayer(
                    player=self.player_val, mpvplayer=self.mpvplayer_val
                )
                self.mpvplayer_val.setProcessChannelMode(QtCore.QProcess.MergedChannels)
                self.mpvplayer_val.started.connect(self.started)
                self.mpvplayer_val.readyReadStandardOutput.connect(
                    partial(self.dataReady, self.mpvplayer_val)
                )
                self.mpvplayer_val.finished.connect(self.finished)
                QtCore.QTimer.singleShot(
                    100, partial(self.mpvplayer_val.start, command)
                )
                logger.info(command)
    ...
    def setLabelTextStyle(self, label_txt, color):
        ...
        if ui.player_theme == "default":
            label_txt.setStyleSheet(
                ...
                """.format(
                    self.global_font, color, bold=font_bold, size=font_size
                )
            )
        elif self.player_theme == "system":
            label_txt.setStyleSheet(
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        print(e)
                p1 = "self.label_epn_{0}.setAlignment(QtCore.Qt.AlignCenter)".format(
                    new_cnt
                )
                exec(p1)
                QtWidgets.QApplication.processEvents()
            ...
            if (
                ...
                try:
                    ...
                    try:
                        ...
                        print(e, "--line--4597--")
                        try:
                            p1 = 'self.label_epn_{0}.setText("{1}")'.format(
                                init_cnt, txt
                            )
                            exec(p1)
                        except Exception as e:
    ...
    def localGetInList(self, eofcode=None):
        ...
        if (
            ...
            command = self.mplayermpv_command(
                self.idw, finalUrl, self.player_val, a_id=audio_id, s_id=sub_id
            )
            if (
                not self.external_url
                and self.mpvplayer_started
                and not self.external_audio_file
            ):
                finalUrl = finalUrl.replace('"', "")
            ...
            if (
                self.cur_row == 0 or eofcode == "next"
            ) and self.playback_mode == "playlist":
                cmd = "\n set playlist-pos {} \n".format(self.cur_row)
                if self.mpvplayer_val.processId() > 0:
                    self.mpvplayer_val.write(bytes(cmd, "utf-8"))
        ...
        try:
            if site == "Music":
                try:
                    artist_name_mplayer = self.epn_arr_list[row].split("	")[2]
                    if (
                        artist_name_mplayer.lower() == "none"
                        or "http" in artist_name_mplayer
                    ):
                        artist_name_mplayer = ""
                except:
                    artist_name_mplayer = ""
                ...
                try:
                    ...
                    logger.error(
                        "Error in getting Thumbnail -14179- epnfound: {0}".format(e)
                    )
            else:
                try:
                    thumb_path = self.get_thumbnail_image_path(
    ...
    def getQueueInList(self, eofcode=None):
        ...
        command = self.mplayermpv_command(
            self.idw, epnShowN, self.player_val, a_id=audio_id, s_id=sub_id
        )
        if (
            self.mpvplayer_val.processId() > 0
            and not self.epn_wait_thread.isRunning()
    ...
    def mplayermpv_command(
        ...
        if player.lower() == "mplayer":
            if finalUrl.startswith("http"):
                command = "mplayer -idle -identify -msglevel statusline=5:global=6 -cache 100000 -cache-min 0.001 -cache-seek-min 0.001 -osdlevel 1 -slave -wid {0}".format(
                    idw
                )
            else:
                command = "mplayer -idle -identify -msglevel statusline=5:global=6 -nocache -osdlevel 1 -slave -wid {0}".format(
                    idw
                )
            if aspect_value == "0":
            ...
            command = command + ' -vf screenshot="{0}"'.format(
 ...
 --screenshot-directory="{3}"'.format(
                    aspect_value, idw, self.custom_key_file, self.screenshot_directory
                )
            else:
                command = 'mpv --cache-secs=120 --cache=auto\
 --cache-initial=0 --cache-seek-min=100 --cache-pause\
 ...
 --screenshot-directory="{3}"'.format(
                    aspect_value, idw, self.mpv_input_conf, self.screenshot_directory
                )
        else:
        ...
        if a_url:
            ...
            self.append_audio_start = False
        if (
            self.gapless_playback or self.gapless_network_stream
        ) and player.lower() == "mpv":
        ...
        if self.subtitle_dict and self.apply_subtitle_settings:
            ...
            for key, value in self.subtitle_dict.items():
                if player.lower() == "mpv":
                    ...
                    if key == "sub-font":
                        ...
                        ass_mplayer.append(
                            "PrimaryColour=&H00{}".format(value[1:][::-1])
                        )
                    elif key == "sub-border-color":
                        ass_mplayer.append(
                            "OutlineColour=&H00{}".format(value[1:][::-1])
                        )
            ...
            if player.lower() == "mplayer":
                if ass_override and ass_mplayer:
                    ...
                    command = command + ' -ass-force-style "{}"'.format(
                        ",".join(ass_mplayer)
                    )

        elif (
            self.subtitle_dict
            and not self.apply_subtitle_settings
            and player.lower() == "mpv"
        ):
        ...
        if player == "MPV":
            command = re.sub(
                "-wid [0-9]+|--input-vo-keyboard=no|--input-terminal=no", "", command
            )
            command = re.sub(
                "--cursor-autohide=no|--no-input-cursor|--no-osc|--no-osd-bar|--ytdl=no",
                "",
                command,
            )
        elif player == "MPLAYER":
        ...
        if (
            self.player_val.lower() == "mpv"
            and self.use_custom_config_file
            and self.mpvplayer_string_list
        ):
        ...
        if finalUrl:
            ...
            if self.quality_val == "best" and self.ytdl_path == "default":
                if (
                    "youtube.com" in finalUrl or finalUrl.startswith("ytdl:")
                ) and player == "mpv":
            ...
            if (
                ...
                and site in self.local_site_list
                and player.lower() == "mpv"
            ):
            ...
            if site != "Local":
                ...
                try:
                    if self.video_local_stream:
                        if (
                            self.torrent_serve_thread.isRunning()
                            and self.torrent_status_thread.isRunning()
                        ):
                            finalUrl = self.start_torrent_stream(
                                name,
                                row,
                        ...
                        print(
                            self.epn_wait_thread.isRunning(),
                            self.cur_row,
                            epn,
                            "--10619--",
                        )
    ...
    def update_playlist(self, pls):
        ...
        if os.path.exists(file_path) and self.btn1.currentText().lower() == "youtube":
            ...
            os.path.exists(file_path) and self.btn1.currentText().lower() == "playlists"
        ):
    ...
    def options(self, val=None):
        ...
        if bookmark:
            ...
            if not os.path.exists(music_db):
                self.media_data.create_update_music_db(
                    music_db, music_file, music_file_bak
                )
                update_start = 1
            elif not update_start:
                update_start = 1
                self.update_thread = UpdateMusicThread(
                    self, music_db, music_file, music_file_bak
                )
            ...
            if (
                ...
                or music_opt == "Album"
                or music_opt == "Title"
                or music_opt == "Fav-Artist"
                or music_opt == "Fav-Album"
            ):
                for i in artist:
                    self.original_path_name.append(i)
                    self.list1.addItem((i))
            ...
            if not os.path.exists(video_db):
                self.media_data.create_update_video_db(
                ...
                if msgreply == QtWidgets.QMessageBox.Yes:
                    self.media_data.update_on_start_video_db(
                        video_db, video_file, video_file_bak, video_opt
                    )
            ...
            if video_opt.lower() != "update" or video_opt.lower() != "updateall":
                ...
                for i in artist:
                    ...
                    if os.path.exists(di) or show_all:
                        eptitle = ti.lower()
                        if (
                            eptitle.startswith("season")
                            or eptitle.startswith("special")
            ...
            if self.list3.currentItem():
                ...
                if txt == "list":
                    ...
                    if fname:
                        ...
                        for i in file_list:
                            ...
                            if "." in j:
                                k = j.rsplit(".", 1)[1]
                                if (
                                    k in self.music_type_arr
                                    or k in self.video_type_arr
                                    or k == "m3u"
                                    or k == "pls"
                                ):
                                    if k != "m3u" and k != "pls":
                    ...
                    item, ok = QtWidgets.QInputDialog.getText(
                        MainWindow,
                        "Input Dialog",
                        "Enter Url of External Media or Playlist",
                    )
                    if ok and item:
                        if txt == "open url":
                            self.list2.clear()
        ...
        if (
            self.view_mode in ["thumbnail", "thumbnail_light"]
            or not self.tab_6.isHidden()
            ...
            if site == "NotMentioned":
                ...
                if (
                    opt == "History"
                    or (site == "Video" or site == "PlayLists")
                    or bookmark
                ):
    ...
    def apply_new_style(self, mode=None):
        if mode is None:
            change_opt_file(
                HOME_OPT_FILE, "THEME=", "THEME={0}".format(self.player_theme.upper())
            )
    ...
    def watch_external_video(self, var, mode=None, start_now=None):
        ...
        if (
            ...
            if t.endswith(".m3u") or t.endswith(".pls"):
                ...
                content = ccurl(t + "#" + "-I")
                if (
                    "www-authenticate" in content.lower()
                ...
                if m3u_file:
                    ...
                    if (
                        ...
                        self.start_gapless_stream_process(
                            length, link=title_url.replace("ytdl:", "", 1)
                        )
                    if mode == "open url":
                        file_name = os.path.join(
                            self.home_folder, "Playlists", "TMP_PLAYLIST"
                        )
                ...
                if os.path.isfile(t):
                    ...
                    self.watchDirectly(
                        urllib.parse.unquote('"' + t + '"'), self.epn_name_in_list, "no"
                    )
                    self.dockWidget_3.hide()
                    site = "PlayLists"
                    self.btn1.setCurrentIndex(self.btn1.findText(site))
    ...
    def setup_opengl_widget(self, app):
        ...
        if isinstance(libmpv_api, str) and libmpv_api.lower() in [
            "opengl-cb",
            "opengl-render",
        ]:
        ...
        self.gridLayoutVideoPls.setAlignment(
...
def save_all_settings_before_quit():
    ...
    if ui.float_window_open:
        if (
            ui.float_window.width() != screen_width
            and ui.float_window.height() != screen_height
        ):
            ui.float_window_dim = [
                ui.float_window.pos().x(),
                ui.float_window.pos().y(),
                ui.float_window.width(),
                ui.float_window.height(),
            ]
    ...
    with open(ui.playing_history_file, "wb") as pls_file:
        if ui.list1.currentItem():
            ...
            ui.history_dict_obj.update(
                {"#LIBMPV@WATCH#LATER": [ui.history_dict_obj_libmpv]}
            )
...
def main():
    ...
    finalUrlFound = False
    refererNeeded = False
    site_arr = ["Local", "PlayLists", "Bookmark", "Music", "Video", "YouTube", "None"]
    default_option_arr = [
        "Select",
        "Video",
        "Music",
    ...
    ui = Ui_MainWindow()
    ui.setupUi(
        MainWindow, media_data=media_data, variable_width_list=variable_width_list
    )
    ...
    if os.path.isfile(ui.playing_history_file):
        with open(ui.playing_history_file, "rb") as pls_file_read:
            ...
            if "#LIBMPV@WATCH#LATER" in ui.history_dict_obj:
                ui.history_dict_obj_libmpv = ui.history_dict_obj["#LIBMPV@WATCH#LATER"][
                    0
                ].copy()
    ...
    if ui.player_theme == "mix":
        QtCore.QTimer.singleShot(
            100,
            partial(
                ui.set_mainwindow_palette,
                ui.default_background,
                first_time=True,
                theme="default",
            ),
        )
        ...
        QtCore.QTimer.singleShot(
            100,
            partial(
                ui.set_mainwindow_palette, picn, first_time=True, theme=ui.player_theme
            ),
        )
    ...
    if os.path.exists(os.path.join(home, "src", "Plugins")):
        ...
        for i in m:
            if i.endswith(".py"):
                ...
                if (
                    i != "headlessBrowser"
                    and i != "headlessEngine"
                    and i != "stream"
                    and i != "local_ip"
                    and i != "headlessBrowser_webkit"
                    and i != "installPlugins"
                    and i != "__init__"
                ):
    ...
    if option_index >= 0 and option_index < ui.list3.count():
        ...
        if (
            option_val
            and option_val.lower() != "update"
            and option_val.lower() != "updateall"
        ):
            if option_val == "History":
                print("--setting-history-option--")
                opt = "History"
                ...
                if ui.btn1.currentText() == "Addons":
                    if option_sitename:
                        ...
                        list3_item = ui.list3.findItems(
                            siteName, QtCore.Qt.MatchExactly
                        )
                        if list3_item:
                            list3_row = ui.list3.row(list3_item[0])
                            ui.list3.setFocus()
                            ui.list3.setCurrentRow(list3_row)
                            ui.list3.itemDoubleClicked["QListWidgetItem*"].emit(
                                list3_item[0]
                            )
    ...
    if name_index >= 0 and name_index < ui.list1.count():
        ...
        if (
            "#LAST@TITLE" in ui.history_dict_obj
            and site.lower() == "video"
            and opt.lower() == "history"
        ):
    ...
    try:
        ui.tray_widget = SystemAppIndicator(
            ui_widget=ui, home=home, window=MainWindow, logr=logger
        )
    ...
    try:
        ...
        logger.error(
            "Error in Tray Widget Event Filter with error message {0}".format(e)
        )
    ...
    if ui.access_from_outside_network:
        get_ip_thread = GetIpThread(
            ui, interval=ui.get_ip_interval, ip_file=ui.cloud_ip_file
        )
        get_ip_thread.start()
    ...
    if ui.view_mode in ["thumbnail", "thumbnail_light"]:
        ...
        if ui.view_mode == "thumbnail":
            ...
            ui.experiment_list(
                {"mode": "start", "epi": episode_index, "title_index": name_index}
            )
    ...
    try:
        if (
            os.path.isfile(ui.settings_box.config_file_name)
            and ui.use_custom_config_file
        ):
