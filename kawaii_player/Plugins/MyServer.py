    ...
    def handleLogin(self):
        ...
        if url:
            ...
            if not url.startswith("http"):
                ...
                print(content, ">>>>>")
                if (
                    "Access Not Allowed, Authentication Failed" in content
...
class MyServer:
    ...
    def getCompleteList(self, opt, genre_num=None, next_login=None):
        ...
        if opt.lower() == "login":
            ...
            if self.site is None:
                ...
                print(url_new)
                content = ccurl(
                    url_new + "#" + "-b" + "#" + self.cookie_file, verify_peer=False
                )
                # print(content)
                m = content.split("\n")
    ...
    def getEpnList(self, name, opt, depth_list, extra_info, siteName, category):
        ...
        if self.site:
            ...
            content = ccurl(
                url + "#" + "-b" + "#" + self.cookie_file, verify_peer=False
            )
